...
//CODE HERE
const compareNums = () => (compareNums,1,12)
...
//CODE HERE
const nameCheck = (nameThatWillBe) => {
console.log (nameThatWillBe)
if (nameThatWillBe === 'steven'){
  return ("what is up Steven");
} else if (nameThatWillBe === 'Bryan')
  return ( 'Hey Bryan'); {
  } return (' Cool name' + (nameThatWillBe))
}
console.log (nameCheck(' Zachary '))
const nameGreeting = nameCheck('Zachary');
...
const faveColorFinder = (color) => {
 ...
 if (color === 'red'){
   ...
   return ('so trendy');
 } return ('you need to evaluate your favorite color of choice')
}
...
const thatsOdd = (nums) => {
  ...
  if (evenNums.includes(nums)) {
    return ('Thats not odd')
  } return ('That is odd indeed')
}
console.log (thatsOdd(6))
...
//CODE HERE
const bestMovie = LOTR => {
  return ' LOTR ' + 'is the best movie ever!' 
}
...
let arrayEvaluator = bigOrSmall(bigOrSmall)
////////////////// PROBLEM 16 ////////////////////
...
uppercaseStr ('hi , my name is Kylo..')
////////////////// PROBLEM 18 ////////////////////
/*
...
let totalFrogs = buyChocolateFrogs(100)
...
let totalFrogs2 = buyChocolateFrogs2(100)
////////////////// PROBLEM 21 ////////////////////
